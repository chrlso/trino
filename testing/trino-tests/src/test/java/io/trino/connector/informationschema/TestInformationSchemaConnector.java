    ...
    public void testMetadataCalls()
    {
        assertMetadataCalls(
                ...
                ImmutableMultiset.<String>builder()
                        .addCopies("ConnectorMetadata.canonicalize", 6)
        ...
        assertMetadataCalls(
                ...
                "VALUES (1000, 1000)",
                ImmutableMultiset.<String>builder()
                        .addCopies("ConnectorMetadata.canonicalize", 4)
                        .add("ConnectorMetadata.getRelationTypes(schema=test_schema1)")
        ...
        assertMetadataCalls(
                ...
                "VALUES (3000, 3000)",
                ImmutableMultiset.<String>builder()
                        .addCopies("ConnectorMetadata.canonicalize", 122)
                        .add("ConnectorMetadata.getRelationTypes")
                        .build());
        assertMetadataCalls(
                ...
                ImmutableMultiset.<String>builder()
                        ...
                        .addCopies("ConnectorMetadata.canonicalize", 11)
